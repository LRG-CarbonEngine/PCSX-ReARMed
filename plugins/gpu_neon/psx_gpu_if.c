...
#include "../gpu_neon/psx_gpu/psx_gpu.c"
#include "../gpu_neon/psx_gpu/psx_gpu_parse.c"
...
void renderer_set_config(const struct rearmed_cbs *cbs)
{
  ...
  gpu.state.enhancement_enable = pl_rearmed_cbs.gpu_neon.enhancement_enable;
#elif defined(GEX)
   egpu.hack_disable_main = cbs->gpu_neon.enhancement_no_main;
   egpu.hack_texture_adj = cbs->gpu_neon.enhancement_tex_adj;
   gpu.state.enhancement_enable = pl_rearmed_cbs.gpu_neon.enhancement_enable;
  ...
  egpu.hack_texture_adj = cbs->gpu_neon.enhancement_tex_adj;
  gpu.state.enhancement_enable = pl_rearmed_cbs.gpu_neon.enhancement_enable;
#else // TODO: Need to investigate these with Gex 1
    egpu.hack_disable_main = 0;
    egpu.hack_texture_adj = 0; //cbs->gpu_neon.enhancement_tex_adj;
    gpu.state.enhancement_enable = 0;
#endif 
